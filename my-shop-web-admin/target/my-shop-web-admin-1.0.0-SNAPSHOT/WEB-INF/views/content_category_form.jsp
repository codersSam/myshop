                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="box box-info">
                            <div class="box-header with-border">
                                <h3 class="box-title">${tbContentCategory.name == null ? "新增":"编辑"}类别</h3>
                            ...
                            <form:form id="inputForm" cssClass="form-horizontal" action="/content/category/save" method="post"
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <form:hidden id="parentId" path="parent.id"></form:hidden>
                                            <input id="parentName" path="parent.name" class="form-control required" placeholder="请选择" readonly="true" data-toggle="modal" data-target="#modal-default" value="${tbContentCategory.parent.name}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <form:input path="name" cssClass="form-control required" placeholder="类别名称"></form:input>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <form:input path="sortOrder" cssClass="form-control required" placeholder="排序"></form:input>
                                        </div>
                                    </div>
                                </div>
