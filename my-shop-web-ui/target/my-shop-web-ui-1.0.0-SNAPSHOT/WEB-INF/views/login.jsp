        ...
        <div class="login_form">
            ...
            <div class="kengl_kuang">
                ...
                <div class="txt_kuang">
                    ...
                    <input id="verification" name="verification" type="text" class="itxt"  placeholder="验证码" style="width: 110px">
                    <img id="varificationCode" src="/verification" style="cursor: pointer; float: right;padding-right:34px " title="看不清？换一张 "  />
...
<script>
    $(function () {
        // 刷新验证码
        $("#varificationCode").bind("click", function () {
