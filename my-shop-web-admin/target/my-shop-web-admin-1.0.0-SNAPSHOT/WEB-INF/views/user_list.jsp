                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <button type="button" class="btn btn-sm  btn-default"
                                    onclick="App.deleteMutil('/user/delete')"><i
                        ...
                        <div class="box-body table-responsive">
                            <table id="pageList" class="table table-hover">
                                ...
                                <tbody>
                                <%--<c:forEach items="${tbUserList}" var="tbUser">
                                    <tr>
                                        ...
                                        <td>${tbUser.phone}</td>
                                        <td>${tbUser.email}</td>
                                        <td><fmt:formatDate value="${tbUser.created}" pattern="yyyy-MM-dd HH:mm:ss"
                                        ></fmt:formatDate></td>
                                        <td>
                                            <a href="#" type="button" class="btn btn-sm  btn-default"><i
...
<script>
    ...
    $(function () {
        var _columns = [
            ...
            {
                "data": function (row, type, val, meta) {
                    return '<button type="button" class="btn btn-sm btn-default" onclick="App.showDetail(\'/user/detail?id=' + row.id + '\')"><i class="fa fa-search"></i> 查看</button>&nbsp;&nbsp;&nbsp;' +
                        '<a href="/user/form?id=' + row.id + '\"' + 'type="button" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i> 编辑</a>&nbsp;&nbsp;&nbsp;' +
                        '<button type="button" class="btn btn-sm btn-danger" onclick="App.deleteSingle(\'/user/delete\', '+ row.id + ')"><i class="fa fa-trash-o"></i> 删除</button>'
                }
            }
        ]
